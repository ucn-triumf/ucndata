...
[Ucndata Index](../README.md#ucndata-index) / [Ucndata](./index.md#ucndata) / Settings

> Auto-generated documentation for [ucndata.settings](../../ucndata/settings.py) module.
...
[Show source in settings.py:49](../../ucndata/settings.py#L49)
